...
Der CD-Manager verbessert die Benutzerfreundlichkeit der BaSyX Web UI erheblich, da Concept Descriptions nicht mehr abstrakt „im Hintergrund“, sondern transparent und intuitiv zugänglich sind. Dies führt zu einer höheren Datenqualität, weniger Fehlkonfigurationen und einer insgesamt gesteigerten Akzeptanz des AS-Ansatzes bei Anwenderinnen und Anwendern. Insbesondere lassen sich Zeitgewinne bei der Suche, Pflege und Referenzierung von Concept Descriptions sowie reduzierte Aufwände für Fehleranalyse und Nacharbeit erwarten. Schon konservativ angesetzte Einsparungen von wenigen Stunden pro Monat und Nutzergruppe können, über mehrere Projekte und Organisationen hinweg, die einmaligen Entwicklungskosten des Plugins deutlich übersteigen und so einen klaren wirtschaftlichen Mehrwert erzeugen.

## Zeitlicher Ablauf
Die zeitliche Rahmen des ersten Projektteils geht vom 26.09.2025 bis zum 0.11.2025 statt. In den ersten zwei Wochen wurden die organisatorischen Themen sowie die Projektplanung gemacht. Der Rest der Zeit wurde für die technische Planung und die Entwicklung des Prototyps aufgewendet. Der Gesamtaufwand pro Person dürfte bis Ende des vierten Semesters, wenn das Projekt vollständig abgeschlossen wird, bei ca. 150 bis 200 Stunden pro Person liegen.
...
Die variablen Projektkosten ergeben sich aus den Stundenlöhnen der beteiligten Rollen und der geplanten Arbeitszeit. Die vorausgegangene Tabelle zeigt die Verteilung der Kosten nach Mitarbeitenden.

## Abschließender Vermerk
Obwohl für die Entwicklung Gesamtkosten in Höhe von 25.900 € anfallen, wird das Projekt als Erweiterung eines Open-Source-Projekts veröffentlicht und den Anwendern kostenfrei zur Verfügung gestellt. Eine direkte Monetarisierung über Lizenzgebühren ist nicht vorgesehen. Das Plugin dient vielmehr als Referenz- und Demonstrationsprojekt, mit dem die technische Kompetenz des Unternehmens sichtbar gemacht, die Verbreitung des BaSyx-Ökosystems unterstützt und mittelbar neue Beratungs- und Entwicklungsaufträge gewonnen werden sollen.
Die Finanzierung des Projekts in Höhe von 25.900 € ist damit eine gezielte Investition in Sichtbarkeit, Reputation und zusätzliche Projektumsätze im BaSyx-Umfeld.
